...
export default function authCallbackUrl(environment: Readonly<Record<string, string | undefined>>) {
  ...
  return `https://${hostSchema.parse(host)}/auth/callback?next=/reset-password`;
}
